    ...
    <footer className="bg-[#195FA6] text-white">
      ...
      <div className="lg:hidden px-6 py-10">
        ...
        <div className="flex flex-col items-center">
          <img src={footer} alt="NeuAnchor logo" className="w-24 h-24 mb-2" />
          <p className="text-3xl font-bold leading-tight">NeuAnchor</p>
          <p className="text-xs mt-1 opacity-90">Anchoring Change, Navigating Growth</p>
        </div>

        {/* Quick Links */}
        <div className="mt-8 text-center">
          <h4 className="font-Figtree font-semibold mb-4">Quick Links</h4>
        ...
        <div className="mt-10 text-center">
          <h4 className="font-Figtree font-semibold mb-4">Our Brands</h4>
        ...
        <div className="flex flex-col items-center gap-5">
          <p className="text-center text-xs text-white/90">
            Copyright © 2025 Designed and Developed by blu
            <br />
            Bluparrot Ventures
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div className="lg:col-start-2 pl-20 lg:col-span-4 ">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
                {/* Quick Links */}
                <div>
                  <h4 className="text-white font-Figtree font-semibold mb-4">Quick Links</h4>
                ...
                <div>
                  <h4 className="text-white font-Figtree font-semibold mb-4">Our Brands</h4>
                  <ul className="space-y-2 list-none p-0">
                    {brandLinks.slice(0, 4).map((l) => (
                      <li key={l.name}>
                        <a href={l.href} className="text-gray-300 hover:text-white no-underline">
                          {l.name}
                        </a>
                      </li>
                    ))}
                ...
                <div>
                  <h4 className="opacity-0 select-none mb-4">.</h4>
                  <ul className="space-y-2 list-none p-0">
