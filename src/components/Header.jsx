...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <div
        id="mobile-menu"
        className={`md:hidden overflow-hidden transition-[max-height] duration-300 ease-in-out ${isOpen ? 'max-h-[85vh]' : 'max-h-0'}`}
      >
                  ...
                  <div key="our-brands">
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-2 py-2 rounded text-base font-medium transition-colors duration-200
                        ${brandsOpen ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:text-blue-600'}
                      `}
                    >
                      <span>Our Brands</span>
                      <svg
                        className={`w-5 h-5 transition-transform ${brandsOpen ? 'rotate-180 text-blue-600' : 'text-gray-500'}`}
                        viewBox="0 0 20 20"
                        fill="currentColor"
                        aria-hidden="true"
                      >
                      ...
                      <div className="mt-3 rounded-2xl border border-gray-200 p-3">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <div className="flex flex-col gap-1 max-h-[240px] sm:max-h-[260px] overflow-y-auto pr-1 scrollbar-hide">
                            {brands.map((b, i) => {
                              const selected = i === activeBrandIdx;
                              return (
                                <button
                                  key={b.key}
                                  type="button"
                          ...
                          <div className="bg-blue-50 rounded-xl p-3">
                            <div className="bg-white rounded-xl p-3 shadow-sm border border-blue-100 h-[240px] sm:h-[260px] flex flex-col overflow-hidden">
                              <h4 className="text-[13px] leading-4 text-gray-900">
                                <span className="font-normal">{activeBrand.titleLight} </span>
                                <span className="font-semibold">{activeBrand.titleBold}</span>
                              </h4>
                              ...
                              >
                                ...
                                <svg className="ml-1 w-4 h-4" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                  <path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l5 5a1 1 0 01-.042 1.457l-5 4.5a1 1 0 11-1.33-1.494L13.586 10H4a1 1 0 110-2h9.586l-3.293-3.293a1 1 0 010-1.414z" clipRule="evenodd" />
                                </svg>
                              </Link>
                            </div>
                          </div>
