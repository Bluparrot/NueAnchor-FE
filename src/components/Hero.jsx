							...
							<div className="space-y-4">
								...
								<p className="font-Figtree font-medium text-[14px] leading-[1.55] md:text-[15px] lg:text-[17px] lg:leading-relaxed text-gray-600 max-w-[560px]">
									<span className="block lg:hidden">
										A family of brands delivering solutions
										in education, careers, healthcare,
										events, hospitality, and gifting.
									</span>
									<span className="hidden lg:block">
										Welcome to NeuAnchor, your comprehensive
										destination for holistic growth and
										well-being. Offering specialised
										consultations for special needs,
										education, career guidance, leadership
										and motivational conferences, self-paced
										online life skills courses, bespoke
										gifting, and curated specialised meals,
										we bring together a diverse range of
										services under one trusted umbrella.
										Explore personalised solutions designed
										to support your journey and anchor your
