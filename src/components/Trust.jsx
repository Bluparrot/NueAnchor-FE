        ...
        <ul className="flex flex-col gap-10" role="list">
          {trustData.map((item, i) => (
            <li key={i} className="flex flex-col items-center text-center">
              <div className="w-36 h-36 mb-4 rounded-full bg-[#1D69B5] flex items-center justify-center text-white shadow-md">
                {item.icon}
              </div>
              <h3 className="font-Figtree text-[20px] font-semibold leading-tight text-[#111]">
                {item.title}
              </h3>
              <p className="font-Figtree text-[20px] font-semibold leading-tight text-[#111]">
                {item.subtitle}
              </p>
            </li>
          ))}
